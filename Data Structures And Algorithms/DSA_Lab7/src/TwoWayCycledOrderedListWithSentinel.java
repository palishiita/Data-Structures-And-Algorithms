...
public class TwoWayCycledOrderedListWithSentinel<E extends Comparable<E>> implements IList<E> {
    ...
    public boolean add(E e) {
        if (this.isEmpty()) {
            ...
            while (pos.next != sentinel && e.compareTo(pos.next.object) >= 0) {
                pos = pos.next;
            }
    ...
    private Element getElement(E obj) {
        Element pos = sentinel.next;
        while (pos != sentinel && !pos.object.equals(obj)) {
            pos = pos.next;
        }
        if (pos != sentinel && pos.object.equals(obj)) {
            return pos;
        }
        return null;
    }
    ...
    public void removeAll(E e) {
        ...
        while (pos != sentinel && pos.object.equals(e)) {
            pos = pos.next;
            pos.prev.remove();
            size--;
        }
